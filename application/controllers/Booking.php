		...
		{ 
			...
			if(!empty($_POST)){ 
				...
				if($orders[0]->service_type == "treatment"){
					$this->data['content'] = 'admin/booking/detail_treatment_v'; 

				}else{
					$this->data['content'] = 'admin/booking/detail_repair_v'; 
				}
				$this->load->view('admin/layouts/page',$this->data); 
			}
		}
	...
	public function dataList()
	{
        ...
        { 
            ...
            {  
            	...
            	$view_url = "<a href='".base_url()."booking/detail/".$data->id."' class='btn btn-sm white'><i class='fa fa-detail'></i> Detail</a>";
