    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Membuat Area</h3>
        </div>
          ...
          <div class="box-body">
            ...
            <div class="full-width">
              <div class="md-form-group full-width">
                ...
                <label for="code" class="form-control-feedback">Kode Area</label>
              </div>
            </div>
            <div class="full-width">
              <div class="md-form-group full-width">
                <input class="md-input" id="name" name="name" autocomplete="off" required>
                <label for="name" class="form-control-feedback">Nama Area</label>
              </div>
            </div>  
            <div class="full-width">
              <div class="md-form-group  full-width">
            ...
            <div class="form-group row m-t-md">
              <div class="col-sm-12 text-right">
                ...
                <a href="<?php echo base_url();?>area" class="btn btn-sm btn-danger uppercase">Cancel</a>
              </div>
            </div> 
          </div> 
        </form>
...
<div class="padding"></div>
 <script data-main="<?php echo base_url()?>assets/js/main/main-area" src="<?php echo base_url()?>assets/js/require.js"></script>