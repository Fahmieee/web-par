        ...
        <div class="box-body">
           <form class="form-horizontal" id="form" method="POST" action="">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="name" class="form-control" id="code" placeholder="Kode Negara" name="code">
              </div>
            </div>
            <div class="form-group row">
              <label for="inputPassword3" class="col-sm-2 control-label">Nama Negara</label> 
              <div class="col-sm-10">
               <input type="name" class="form-control" id="name" placeholder="Nama Negara" name="name">
              </div>
            </div> 
            <div class="form-group row">
