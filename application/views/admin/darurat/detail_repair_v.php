        ...
        <div class="box-body"> 
          <div class="form-group row m-t-md">
            <div class="col-sm-12 text-right"> 
              <a href="<?php echo base_url();?>darurat" class="btn btn-sm btn-default ">Batal</a>
            </div>
          </div> 
        </div>  
      </div>
...
<div class="padding"></div>
 <script data-main="<?php echo base_url()?>assets/js/main/main-darurat" src="<?php echo base_url()?>assets/js/require.js"></script>