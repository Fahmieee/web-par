          ...
          <div class="box-body">
            ...
            <div class="full-width">
              <div class="md-form-group  full-width">
                <input class="md-input" id="name" name="name" autocomplete="off" value="<?php echo $name;?>" required readonly>
                <label for="name" class="form-control-feedback">Nama Lengkap</label>
              </div>
            </div>
            <div class="full-width">
              <div class="md-form-group  full-width">
                <input class="md-input" id="email" name="email" autocomplete="off" value="<?php echo $email;?>" required readonly>
                <label for="email" class="form-control-feedback">Email</label>
              </div>
            </div>  
            <div class="full-width">
              <div class="md-form-group  full-width">
                <input class="md-input" id="phone" name="phone" autocomplete="off" value="<?php echo $phone;?>" required readonly>
            ...
            <div class="full-width">
              <div class="md-form-group  full-width">
                <input class="md-input" id="nip" name="nip" autocomplete="off" value="<?php echo $nip;?>" required disabled>
                <label for="phone" class="form-control-feedback">Nomor NIP</label>
              </div>
            </div>  
            <div class="full-width">
              <div class="md-form-group  full-width">
                <input class="md-input" id="nik" name="nik" autocomplete="off" value="<?php echo $nip;?>" required disabled>
            ...
            <div class="full-width">
              <div class="md-form-group  full-width">
                <select id="group_id" name="group_id" class="md-input" disabled>
            ...
            <div class="full-width">
              <div class="md-form-group  full-width">
                <select id="role_id" name="role_id" class="md-input" disabled>
            ...
            <div class="form-group row m-t-md">
              <div class="col-sm-12 text-right"> 
                <a href="<?php echo base_url();?>employee" class="btn btn-sm btn-danger uppercase">Kembali</a>
              </div>
            </div>   
          </div> 
        </form>
