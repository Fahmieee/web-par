        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Ubah Parts Perawatan</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
               ...
               <?php if(!empty($this->session->flashdata('message_error'))){?>
                ...
                <input type="hidden" name="id" value="<?php echo $id;?>"> 
                 <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <!-- <input type="text" class="form-control" id="merk" placeholder="Merk" name="merk" value="<?php echo $merk;?>"> -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="merk" placeholder="KM" name="distance" value="<?php echo $distance;?>">
                  </div>
                </div>
                 <div class="form-group row">
                    <div class="col-sm-9"> 
