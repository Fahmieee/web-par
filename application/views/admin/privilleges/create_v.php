    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Membuat Privilege</h3>
        </div>
        ...
        <div class="box-body">  
          <table class="table table-striped">
            ...
            foreach($menus as $key => $data_menu){?>
              <tr>
                <td class="valign-mid"> 
                  <label class="mar-0 control control--checkbox"> <input type="checkbox" class="cb-element" name="menus[]" 
                    value="<?php echo $data_menu['id'];?>"><div class="control__indicator" style="top:-8px;"></div></label> 
                </td>
