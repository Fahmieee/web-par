      ...
      <form class="form-horizontal" id="form" method="POST" action="">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Detail Privilege</h3>
          </div>
          ...
          <div class="box-body">  
                  ...
                  <tr>
                    <td class="valign-mid"> 
                      <label class="mar-0 control control--checkbox"> 
                        ...
                        value="<?php echo $data_menu['id'];?>"  disabled=""
                          ...
                          foreach($data_menu['functions'] as $function){   
                            ?> 
                             <label class="col-12 control control--checkbox">
                              ...
                              value="<?php echo $function['id']?>" disabled=""
              ...
              <div class="form-group row m-t-md">
                <div class="col-sm-12 text-right"> 
                  <a href="<?php echo base_url();?>privilleges" class="btn btn-sm btn-default uppercase">Kembali</a>
                </div>
              </div>
          </div>  
        </div>  
