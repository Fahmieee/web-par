              ...
              <div class="col-md-12 row">
                <div class="col-md-4  offset-md-3">
                  <div class="md-form-group">
                    <input class="md-input" id="police_number" name="police_number" autocomplete="off" value="<?php echo $units->no_police?>" readonly>
            ...
            <div class="box-body">
              <div class="form-group row m-t-md">
                <div class="col-sm-6">
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <select class="md-input" id="branch_id" disabled>
                  ...
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="merk" name="merk" autocomplete="off" disabled value="<?php echo $units->produk_name?>" >
                      <label for="merk" class="form-control-feedback">Merk Unit</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="model" name="model" autocomplete="off" required value="<?php echo $units->model?>" disabled>
                      <label for="model" class="form-control-feedback">Model Unit</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="varian" name="varian" autocomplete="off" required value="<?php echo $units->varian?>" disabled>
                      <label for="varian" class="form-control-feedback">Varian Unit</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="mes" name="mes" autocomplete="off" required value="<?php echo $units->mes?>"disabled>
                      <label for="mes" class="form-control-feedback">Cakupan Mesin</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="transmition" name="transmition" autocomplete="off" required value="<?php echo $units->transmition?>" disabled>
                ...
                <div class="col-sm-6">
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="years" name="years" autocomplete="off" required value="<?php echo $units->years?>" disabled>
                      <label for="years" class="form-control-feedback">Tahun</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="mileage" name="mileage" autocomplete="off" required value="<?php echo $units->mileage?>" disabled>
                      <label for="mileage" class="form-control-feedback">Jarak Tempuh</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="stnk_due_date" name="stnk_due_date" autocomplete="off" required value="<?php echo $units->stnk_due_date?>" disabled>
                      <label for="stnk_due_date" class="form-control-feedback">Masa Berlaku STNK</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="kir_due_date" name="kir_due_date" autocomplete="off" required value="<?php echo $units->kir_due_date?>" disabled>
                      <label for="kir_due_date" class="form-control-feedback">Masa Berlaku KIR</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="chassis_number" name="chassis_number" autocomplete="off" required value="<?php echo $units->chassis_number?>" disabled>
                      <label for="chassis_number" class="form-control-feedback">Nomor Rangka</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="machine_number" name="machine_number" autocomplete="off" required value="<?php echo $units->machine_number?>" disabled>
                      <label for="machine_number" class="form-control-feedback">Nomor Mesin</label>
                    </div>
                  </div>  
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="color" name="color" autocomplete="off" required value="<?php echo $units->color?>" disabled>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">  
              <div class="full-width">
                <div class="md-form-group col-sm-12">
                  <select class="md-input" id="driver_id" name="driver_id" disabled> 
            ...
            <div class="box-body">  
              <div class="form-group row m-t-md">
                <div class="col-sm-4">
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="start_date" name="start_date" autocomplete="off" required onkeydown="return false" value="<?php echo $start_date?>" disabled>
                ...
                <div class="col-sm-4">
                  <div class="full-width text-center">
                    <div class="md-form-group col-sm-12">
                      <input class="md-input" id="end_date" name="end_date" autocomplete="off" required onkeydown="return false" value="<?php echo $end_date?>" disabled>
                ...
                <div class="col-sm-4">
                  <div class="full-width">
                    <div class="md-form-group col-sm-12">
                      <select class="md-input" id="user_id" name="user_id" disabled> 
