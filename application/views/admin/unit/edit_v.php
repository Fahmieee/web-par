    ...
    <div class="col-md-12"> 
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form Ubah Unit</h3>
        </div> 
        ...
        <div class="box-body">
              ...
              <div class="col-sm-9">
               <select id="type_assets" name="type_assets" class="form-control">
                <option value="">Pilih Kepemilikan Aset</option>
                 <option value="1" <?php  if($type_assets == 1) echo "selected";?>>PAR</option>
                 <option value="2" <?php  if($type_assets == 2) echo "selected";?>>Vendor</option>
               </select>
              </div>  
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-9">
                <select name="type_unit" id="type_unit" class="form-control">
                 ...
                 <option value="1" <?php  if($type_unit == 1) echo "selected";?>>Dedicated</option>
                 <option value="2"  <?php   if($type_unit == 2) echo"selected";?>>Pool</option>
                 </select>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <!-- <input type="text" class="form-control" id="merk" placeholder="Merk Unit" name="merk" value="<?php echo $merk;?>"> -->
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="model" placeholder="Model Unit" name="model" value="<?php echo $model;?>">
            </div>
          </div> 
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Varian Unit</label> 
            <div class="col-sm-9">
              <input type="name" class="form-control" id="varian" placeholder="Varian Unit" name="varian" value="<?php echo $varian;?>">
            </div>
          </div>   
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Tahun</label> 
            <div class="col-sm-9">
              <input type="text" class="form-control" id="years" placeholder="Tahun Unit" name="years"  value="<?php echo $years;?>">
            </div>
          </div>    
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Kapasitas Mesin</label> 
            <div class="col-sm-9">
              <input type="text" class="form-control" id="mes" placeholder="Kapasitas Mesin" name="mes" value="<?php echo $mes;?>">
            </div>
          </div>    
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Transmisi</label> 
            <div class="col-sm-9">
              <input type="text" class="form-control" id="transmition" placeholder="Transmisi" name="transmition" value="<?php echo $transmition;?>">
            </div>
          </div>    
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">No Polisi</label> 
            <div class="col-sm-9">
              <input type="text" class="form-control" id="no_police" placeholder="No Polisi" name="no_police" value="<?php echo $no_police;?>">
            </div>
          </div>    
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Jarak Tempuh</label> 
            <div class="col-sm-9">
              <input type="text" class="form-control" id="mileage" placeholder="Jarak Tempuh" name="mileage" value="<?php echo $mileage;?>">
            </div>
          </div>  
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Masa Berlaku STNK</label> 
            <div class="col-sm-9">
              <input type="name" class="form-control" id="stnk_due_date" placeholder="Masa Berlaku STNK" name="stnk_due_date" value="<?php echo $stnk_due_date;?>" onkeydown="return false">
            </div>
          </div> 
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Masa Berlaku KIR</label> 
            <div class="col-sm-9">
              <input type="name" class="form-control" id="kir_due_date" placeholder="Masa Berlaku KIR" name="kir_due_date" value="<?php echo $kir_due_date;?>" onkeydown="return false">
            </div>
          </div>  
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Nomor Rangka</label> 
            <div class="col-sm-9">
              <input type="name" class="form-control" id="chassis_number" placeholder="Nomor Rangka" name="chassis_number" value="<?php echo $chassis_number;?>">
            </div>
          </div>  
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Nomor Mesin</label> 
            <div class="col-sm-9">
              <input type="name" class="form-control" id="machine_number" placeholder="Nomor Mesin" name="machine_number" value="<?php echo $machine_number;?>">
            </div>
          </div>  
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 control-label">Warna</label> 
            <div class="col-sm-9">
              <input type="name" class="form-control" id="color" placeholder="Warna" name="color" value="<?php echo $color;?>">
            </div>
          </div>  
