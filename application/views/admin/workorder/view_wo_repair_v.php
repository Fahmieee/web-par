          ...
          <div class="full-width">
            <div class="form-group row m-t-md"> 
              <div class="col-sm-6">
                ...
                <div class="full-width text-center">
                  <div class="md-form-group col-sm-12">
                  <input class="md-input" id="tgl_order" name="tgl_order" autocomplete="off"  readonly="" value="<?php echo $orders->est_biaya_maintenance?>" >
      ...
      <div class="box box-primary">  
        ...
        <div class="box-body"> 
          <div class="form-group row  col-sm-12">
            ...
            <div class="md-form-group  col-sm-6">
              <input type="text"  class="md-input" id="merk" name="merk" value="<?php echo $units->merk;?>" readonly>
          ...
          <div class="full-width">
            <div class="form-group row m-t-md">
              ...
              <div class="col-sm-6">
                <div class="form-group row  col-sm-12">
                  <div class="md-form-group  col-sm-6">
                    <input type="text"  class="md-input" value="<?php 
                      if($orders->service_type =="treatment"){
                        echo "Perawatan";
                      }else if($orders->service_type =="repair"){
                        echo "Perbaikan";
                      }else{
                        echo "Darurat";
                      }
                  ...
                  <div class="col-sm-8 "> 
                    ...
                    <?php foreach($parts as $part){?>
                      <div class="row col-sm-12">
                          ...
                          <div class="col-sm-6">  <a href="<?php echo base_url()?>assets/images/repair/<?php echo $part->file;?>" target="_blank"><span class="fa fa-image"></span><?php echo $part->file;?> </a> </div> 
                      </div> 
                  <?php }?>
                  </div> 
                </div>  
        ...
        <div class="box-body"> 
          <div class="form-group row m-t-md">
            <div class="col-sm-12 text-right"> 
              <a href="<?php echo base_url();?>workorder" class="btn btn-sm btn-default ">Batal</a>
            </div>
          </div> 
        </div>  
      </div>
