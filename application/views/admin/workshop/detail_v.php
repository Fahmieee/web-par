    ...
    <div class="col-md-12">
         ...
         <?php if(!empty($this->session->flashdata('message_error'))){?>
          ...
          <div class="full-width">
            <div class="md-form-group full-width">
               <select id="rekanan" name="rekanan" class="md-input" disabled="">
          ...
          <div class="full-width">
            <div class="md-form-group full-width">
              <input class="md-input" id="code" name="code" autocomplete="off" required value="<?php echo $code;?>" disabled="">
              <label for="code" class="form-control-feedback">Kode Bengkel</label>
            </div>
          </div> 
          <div class="full-width">
            <div class="md-form-group full-width">
              <input class="md-input" id="name" name="name" autocomplete="off" required value="<?php echo $name;?>" disabled="">
              <label for="name" class="form-control-feedback">Nama Bengkel</label>
            </div>
          </div>   
          <div class="full-width">
            <div class="md-form-group full-width">
              <input class="md-input" id="phone_number" name="phone_number" autocomplete="off" required value="<?php echo $phone_number;?>" disabled="">
              <label for="phone_number" class="form-control-feedback">No Telp Bengkel</label>
            </div>
          </div>  
          <div class="full-width">
            <div class="md-form-group full-width">
              <select id="area_id" name="area_id" class="md-input" disabled="">
          ...
          <div class="full-width">
            <div class="md-form-group full-width">
             <select id="city_id" name="city_id" class="md-input" disabled="">
          ...
          <div class="full-width">
            <div class="md-form-group   full-width">
              <textarea class="md-input" id="address" name="address" autocomplete="off" required disabled=""><?php echo $address;?></textarea>
              <label for="address" class="form-control-feedback">Alamat</label>
            </div>
          </div>
          <div class="full-width">
            <div class="md-form-group full-width">
              <input class="md-input" id="lat" name="lat" autocomplete="off" required value="<?php echo $lat;?>" disabled="">
              <label for="lat" class="form-control-feedback">Latitude</label>
            </div>
          </div>
          <div class="full-width">
            <div class="md-form-group full-width">
              <input class="md-input" id="long" name="long" autocomplete="off" required value="<?php echo $long?>" disabled="">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body"> 
          <div class="full-width">
            <div class="md-form-group full-width">
              <input class="md-input" id="merk" name="merk" autocomplete="off" readonly value="<?php echo $produk_name;?>">
        ...
        <div class="box-body" id="pic-container"> 
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="full-width">
                <div class="md-form-group full-width">
                  <input class="md-input" id="pic_name" name="pic_name[]" autocomplete="off" value="<?php echo $pic->name;?>" disabled="">
            ...
            <div class="col-md-3">
              <div class="full-width">
                <div class="md-form-group full-width">
                  <input class="md-input" id="pic_phone" name="pic_phone[]" autocomplete="off"  value="<?php echo $pic->phone;?>" disabled="">
            ...
            <div class="col-md-3">
              <div class="full-width">
                <div class="md-form-group full-width">
                  <input class="md-input" id="pic_email" name="pic_email[]" autocomplete="off" value="<?php echo $pic->email;?>" disabled="">
            ...
            <div class="col-md-3">
              <div class="full-width">
                <div class="md-form-group full-width">
                  <select id="pic_cs" name="pic_cs[]" class="md-input" disabled="">
        ...
        <div class="box-body"> 
          <div class="form-group row m-t-sm">
            <div class="col-sm-12 text-right"> 
              <a href="<?php echo base_url();?>workshop" class="btn btn-sm btn-danger uppercase">Kembali</a>
            </div>
          </div>  
        </div>  
      </div> 
