        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Client</h4><br>
                    <button class="btn btn-success" onclick="TambahClient();"><i class="la la-plus"></i> Tambah Client</button> 
                            ...
                            <table class="table table-striped table-bordered datatables" width="100%">
                                ...
                                <tbody> 
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $driverx ? $driverx->username.' - '.$driverx->first_name : 'Tidak ada Driver' }}</td>
                                        <td>{{ $client->jabatan_name }}</td>
                                        <td>{{ $client->wilayah_name }}</td>
                                        <td>
                                            <button class="btn btn-sm btn-danger" onclick="Delete()" type="button"><i class="la la-trash"></i></button> <button class="btn btn-sm btn-info" onclick="Reset({{ $client->id }})" type="button"><i class="la la-key"></i></button>
                                        </td>
                                    </tr> 
                                    @endforeach 
                                </tbody>
