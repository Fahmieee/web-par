        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-car"></i><span class="menu-title" data-i18n="nav.templates.main">Master Data</span></a>
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="#"><i></i><span data-i18n="nav.templates.vert.main">Penilaian Kendaraan</span></a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="#"><i></i><span data-i18n="nav.templates.vert.classic_menu">Type Nilai</span></a>
                            </li>
                            <li><a class="menu-item" href="#"><i></i><span>Detail Nilai</span></a>
            ...
            <li class="nav-item"><a href="#"><i class="la la-star"></i><span class="menu-title" data-i18n="nav.templates.main">Scored</span></a>
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="#"><i></i><span data-i18n="nav.templates.vert.main">Kendaraan</span></a>
                    </li>
                </ul>
            </li>
